    ...
    <el-card class="box-card">
        <div class="tiredpredict__wrapper">
            <div class="tiredpredict__model">
                <div class="tiredpredict__model-title">世界高水平成绩</div>
                <div class="tiredpredict__model-filter">
                    <el-select
                        v-model="selectYear"
                        clearable
                        collapse-tags
                        filterable
                        placeholder="请选择比赛年份"
                        class="tiredpredict__model-filter-selector"
                ...
                <div class="tiredpredict__model-wrapper">
                    <div class="tiredpredict__model-wrapper-echarts" id="tiredpredict_show"></div>
                </div>
            </div>
        </div>
    </el-card>
...
export default {
  ...
  methods: {
    ...
    settiredpredictChart () {
      var chartDom = document.getElementById('tiredpredict_show')
